...
6. Clone Your Fork Locally: `git clone <fork-url>`
...
_Note: You cannot delete a branch that you are currently on. Switch to a different branch first before deleting._
